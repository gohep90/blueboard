...
var areas = [
    {
    	...
    	center: new daum.maps.LatLng(37.544062989758594, 127.00854659142894),
        name : '중구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.631840777111364, 126.9749313865046),
        name : '종로구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.59851932019209, 126.95347706883003),
        name : '서대문구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.607062869017085, 127.07111288773496),
        name : '동대문구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.63654916557213, 126.98446028560235),
        name : '성북구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.57275246810175, 127.04241813085706),
        name : '성동구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.584651324803644, 126.88883849288884),
        name : '마포구',
        path : [
    ...
    , {
    	center: new daum.maps.LatLng(37.637804746356906, 126.9849499526369),
        name : '강북구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.62426016702397, 127.04972198301517),
        name : '도봉구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.68576933760812, 127.05179519176832),
        name : '노원구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.61560949157075 , 127.0698603067608),
        name : '중랑구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.52832838500346 , 127.05621425739997),
        name : '광진구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.55688728718567 , 127.11572074811043),
        name : '강동구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.59078724891012 , 126.8820532241646),
        name : '은평구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.55618136555432 , 126.88111468350257),
        name : '강서구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.55115362835054 , 126.86424384263896),
        name : '양천구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.518160531422964, 126.87803320551292),
        name : '영등포구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.50866409457401, 126.82448044395524),
        name : '구로구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.484995194039676 , 126.90307210948215),
        name : '동작구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.48541219781162, 126.87464355624407),
        name : '금천구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.450734423491305 , 126.92860412739365),
        name : '관악구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.525651340091386 , 127.06690853075564),
        name : '송파구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.5256023840182  , 127.00887369465872  ),
        name : '강남구',
        path : [
    	...
    	center: new daum.maps.LatLng(37.45832171342665 , 126.98878369678239),
        name : '서초구',
        path : [
...
function getListItem(index, places) {
	...
	itemStr ='<div class="seq" id="seq_'+(index)+'"><span class="markerbg"></span><div class="info"><h5>'
			+places.name+'</h5><span>학원 간단한 설명??</span><span class="gray">'
			+places.address+'</span><span class="tel">'
			+places.tel +'</span></div></div>';
