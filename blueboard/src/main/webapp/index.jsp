...
<body>
	<p style="margin-top: 12px; height: 10%; width: 100%; ">
	...
	<div class="map_wrap">
	<div  id="map" style="width: 70%; height: 90%; float: left;"></div>

	<div id="menu_wrap" class="bg_white"
		style="width: 450px; height: 90%; float: left;">
		<div class="option">
			<div>
				<form onsubmit="searchPlaces(); return false;">
					키워드 : <input type="text" value="학원검색" id="keyword" size="15">
...
function displayArea(area) {
	...
	function displayInfowindow(places) {
		...
		var iwContent = '<div class="item"><span class="markerbg" style="float: left;"></span><div class="info" style="float: left;"><span class="name">' 
			+ places.name + '</span><span>학원 간단한 설명??</span><span>' 
