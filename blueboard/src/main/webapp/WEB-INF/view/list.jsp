...
<script type="text/javascript" src="//apis.daum.net/maps/maps3.js?apikey=7a6be21565c5c8e58c1ab67fb77914cf&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
...
function placesSearchCB(status, data, pagination) {
    if (status === daum.maps.services.Status.OK) {
        ...
        //alert(pagination);
   //     $.each(pagination,function(key){
	//			var	test=pagination[key];
	//			alert(key+" : "+test);
	//	});
        // 페이지 번호를 표출합니다
...
function displayPagination(pagination) { //초기 받아오는것!!
