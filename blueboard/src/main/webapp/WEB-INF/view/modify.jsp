...
<script type="text/javascript" src="<c:url value='naver/js/ex11.js'/>"></script>
...
<script type="text/javascript" src="<c:url value='/js/modify.js'/>"></script>
				...
				<div class="join_content">
					<div class="join_form">
						...
						<form id="join_form" method="post"
							action="modifyUser.do" onSubmit="return mainSubmit(0);">
								...
								<div class="row_group">
									...
									<div id="birthdayDiv" class="join_row join_birthday">
										<div class="join_birth">
											...
											<div class="bir_mm">
												<span class="ps_box"><input type="text" id="mm"
													maxlength="2" value=""
													onFocus="toggleLabel('ddLb','dd','in');"
													onBlur="toggleLabel('ddLb','dd','out');checkBirthday('check')"
													placeholder="월" class="int"> <label id="ddLb"
													for="mm" class="lbl">월</label>
													<button type="button" disabled="" title="delete"
														class="wrg">삭제</button>
												</span>
											</div>
							...
							<span class="btn_join">
								<input type="submit" onClick="clickcr(this, 'sup.signup', '', '', event);"
										title="회원가입" alt="회원가입" value="가입하기" class="int_join" style="background:url(http://182.162.22.148:8080/learnway/images/modify.png) no-repeat; background-size:100%;">
							</span>
						</form>
