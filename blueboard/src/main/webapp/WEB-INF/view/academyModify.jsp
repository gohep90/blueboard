...
<script type="text/javascript" src="<c:url value='/js/academyModify.js'/>"></script>
				...
				<div class="jq_cont tab_cont">
					...
					<div id="information" class="cont">
						...
						<div id="name" class="ddiv">
							...
							<input type="text" name="teacherName" id="teacherName" class="content" maxlength="10" value="${row.teacherName}">
						</div>
						...
						<div id="career" class="ddiv">
							...
							<input type="text" name="teacherTel" id="teacherTel" class="content"
								maxlength="20" placeholder="'-'없이 입력" value="${row.teacherTel}">
						</div>
						...
						<div id="book" class="ddiv">
							...
							<textarea name="teacherCareer" id="teacherCareer" class="Lcontent" rows="7">${row.teacherCareer}</textarea>
						</div>
						...
						<div id="etc" class="ddiv">
							...
							<textarea name="teacherIntro" id="teacherIntro" class="Lcontent" rows="7">${row.teacherIntro}</textarea>
					...
					<div class="cont" id="second_content">
						...
						<div id="information" class="cont">
							...
							<div id="academy" class="ddiv" >
								...
								<input type="text" name="academyName" id="academyName" class="content" value="${row.academyName}">
							</div>
							...
							<div id="period" class="ddiv" >
								...
								<input type="text" name="academyTerm" id="academyTerm" class="content" value="${row.academyTerm}">
							</div>
							...
							<div id="day" class="ddiv">
								...
								<input type="text" name="academyWeek" id="academyWeek" class="content" value="${row.academyWeek}">
							</div>
							...
							<div id="time" class="ddiv">
								...
								<input type="text" name="academyTime" id="academyTime" class="content" value="${row.academyTime}">
							</div>
							...
							<div id="money" class="ddiv">
								...
								<input type="text" name="academyPay" id="academyPay" class="content" value="${row.academyPay}">
							</div>
							...
							<div id="total" class="ddiv">
								...
								<input type="text" name="academyTotal" id="academyTotal" class="content" value="${row.academyTotal}">
							</div>
							...
							<div id="address" class="ddiv">
								...
								<input type="text" name="academyAddress" id="academyAddress" class="content" style="width:500px;" value="${row.academyAddress}">
							</div>
							...
							<div id="introduce" class="ddiv">
								...
								<textarea name="academyIntro" id="academyIntro" class="Lcontent" rows="7">${row.academyIntro}</textarea>
							</div>
							...
							<div id="curriculum" class="ddiv">
								...
								<textarea name="academyCurriculum" id="academyCurriculum"  class="Lcontent" rows="10">${row.academyCurriculum}</textarea>
							</div>
